...
with tab_daily:
    ...
    def calculate_daily_metrics(data, filter_type='all'):
        ...
        if pd.to_datetime('2026-05-25').date() in dates and not df_transfer_25_5.empty:
            ...
            cols_order = ['CLV2', 'Số_lượng_chuyển', 'Số_lượng_chênh_lệch', 'Số_lượng_line_chênh_lệch', 'Số_lượng_line_hao_hụt', 'Số_lượng_line_đã_xử_lý', 'Số_lượng_hao_hụt', 'Số_lượng_bs_ST', 'SL_bs_kho_rau', 'Số_lượng_đang_xử_lý', 'Số_lượng_chưa_xác_định']
            grouped = grouped[cols_order]
        
        grouped['Số_lượng_line_còn_lại'] = grouped['Số_lượng_line_chênh_lệch'] - grouped['Số_lượng_line_đã_xử_lý'] - grouped['Số_lượng_line_hao_hụt']
        ...
        grouped = grouped.rename(columns={
            ...
            'Số_lượng_line_còn_lại': 'SL line còn lại',
    ...
    cols = ['CLV2', 'SL chuyển', 'SL chênh lệch', 'SL line chênh lệch', 'SL line hao hụt', 'SL line đã xử lý', 'SL line còn lại', 'Tỷ lệ line đã xử lý', 'Số lượng hao hụt', 'Tỷ lệ hao hụt', 'SL bs ST', 'SL bs kho rau', 'Đang xử lý', 'Chưa xử lý']
    ...
    cols2 = ['CLV2', 'SL chuyển', 'SL chênh lệch', 'SL line chênh lệch', 'SL line hao hụt', 'SL line đã xử lý', 'SL line còn lại', 'Tỷ lệ line đã xử lý', 'Số lượng hao hụt', 'Tỷ lệ hao hụt', 'SL bs ST', 'SL bs kho rau', 'Đang xử lý', 'Chưa xử lý']
